class PdfExportSetting < ActiveRecord::Base
  ...
  validates :marginLeft, :marginRight, :presence => true, :numericality => {:greater_than => 0.5, :less_than => 10}
  validates :marginTop, :marginBottom, :presence => true, :numericality => {:greater_than => 0.5, :less_than => 20}

  #Eventuell brauchen wir hier keine Begrenzung wenn der PDF-Export automatisch Zeilen umbricht.
